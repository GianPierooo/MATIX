...
class Settings(BaseSettings):
    ...
    # ElevenLabs (TTS premium, OPCIONAL y DESACTIVADO por defecto). La voz de
    # Matix es la del DISPOSITIVO (flutter_tts, gratis); el cloud (OpenAI tts-1)
    # solo entra como ÚLTIMO recurso si el device fallara por completo.
    # ElevenLabs queda fuera de la cadena salvo que se active explícito con
    # `tts_elevenlabs_activo=1` (y haya key). El código se conserva, apagado.
    elevenlabs_api_key: str = ""
    elevenlabs_voice_id: str = ""
    tts_elevenlabs_activo: bool = False
